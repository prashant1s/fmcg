...
export const team: TeamMember[] = [
  {
    ...
    name: "Jordan Ellis",
    role: "Founder & CEO",
    bio: "Started Whizoidstudio after a decade running brand social for two Fortune 500 food companies. Obsessed with the intersection of retail and culture.",
  ...
  },
  {
    ...
    bio: "Leads brand and campaign creative across every account. Previously art directed for two DTC beauty unicorns before joining Whizoidstudio.",
  ...
  },
  {
    ...
    bio: "Built Whizoidstudio's creator network of 3,000+ vetted talent from scratch. Negotiates every major partnership personally.",
  ...
  },
  {
    ...
    bio: "Directs and edits Whizoidstudio's in-house video output, from 6-second hooks to full campaign films.",
  ...
  },
  {
    ...
    bio: "Runs community management across every client channel and trains the team behind Whizoidstudio's sub-2-hour response time.",
